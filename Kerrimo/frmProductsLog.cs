...
namespace Kerrimo
{
    public partial class frmProductsLog : Form
    {
        ...
        private void frmProductsLog_Load(object sender, EventArgs e)
        {
            GetData();
        }
        ...
        private void txtProductname_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                while (rdr.Read() == true)
                {
                    dataGridView1.Rows.Add(rdr[0], rdr[1], rdr[2], rdr[3].ToString());
                }
                con.Close();
            }
            catch (Exception ex)
