...
namespace Kerrimo
{
    public partial class frmSuppliersLog1 : Form
    {
        ...
        private void frmSuppliersLog1_Load(object sender, EventArgs e)
        {
            GetData();
        }
        ...
        private void frmSuppliersLog1_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
            frmSuppliers frm = new frmSuppliers();
            frm.Show();
