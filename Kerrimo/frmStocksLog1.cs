...
namespace Kerrimo
{
    public partial class frmStocksLog1 : Form
    {
        SqlDataReader rdr = null;
        SqlConnection con = null;
        SqlCommand cmd = null;
        ConnectionString cs = new ConnectionString();
        public frmStocksLog1()
        {
            InitializeComponent();
        }
        public void GetData()
        ...
        private void frmStocksLog1_Load(object sender, EventArgs e)
        {
            GetData();
        }
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frm.txtSupplierID.Text = dr.Cells[4].Value.ToString();
                frm.cmbSupplierName.Text = dr.Cells[5].Value.ToString();
                frm.txtQty.Text = dr.Cells[6].Value.ToString();
                frm.txtQty1.Text = dr.Cells[6].Value.ToString();
        ...
        private void frmStocksLog1_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
            frmStocks frm = new frmStocks();
            frm.label8.Text = label1.Text;
